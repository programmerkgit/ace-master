...
for (let i in ret.FUNCTION_KEYS) {
    let name = ret.FUNCTION_KEYS[ i ].toLowerCase();
    ret[ name ] = parseInt(i, 10);
}

// A reverse map of PRINTABLE_KEYS
for (let i in ret.PRINTABLE_KEYS) {
    let name = ret.PRINTABLE_KEYS[ i ].toLowerCase();
    ret[ name ] = parseInt(i, 10);
}
...
export const keyCodeToString = function (keyCode) {
